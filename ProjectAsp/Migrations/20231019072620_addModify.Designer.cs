...
namespace ProjectAsp.Migrations
{
    ...
    [Migration("20231019072620_addModify")]
            ...
            modelBuilder.Entity("ProjectAsp.Models.branch.Branch", b =>
                {
                    ...
                    b.HasOne("ProjectAsp.Models.branch.Branch", "parent_id")
                        .WithMany()
                        .HasForeignKey("parent_idId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("company");

                    b.Navigation("parent_id");
                });
